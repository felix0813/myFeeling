...
class DeletePoem extends StatefulWidget {
  var list;

  DeletePoem(this.list);

  @override
  State<StatefulWidget> createState() {
    return DeletePoemState(list);
  }
}

class DeletePoemState extends State<DeletePoem> {
  late List<Poem> list;
  DBManager db = DBManager();
  List<bool> deleteList = [];

  DeletePoemState(this.list);
                  ...
                  onPressed: () async {
                    await showDeleteConfirmDialog1().then((value) async {
                      if (value == true) {
                        ...
                        await User.deleteCloudPoem(ids);
                      }
                    });
                    Navigator.pop(context);
                  },
